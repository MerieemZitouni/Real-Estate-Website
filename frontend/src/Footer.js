...
// const Footer=()=>{
//     return(
//         <div className="bg-gradient-to-r from-green to-bleu w-full h-96"></div>
//     )
// }
...
const Footer = React.forwardRef((props, ref) => {
  return (
    <div ref={ref} id="contact" className="bg-gradient-to-r from-bleu to-green w-full h-96 text-light mt-10">
      <footer className="bg-darkBlue-400">
        <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
          ...
          <p className="mt-8 text-xs text-gray-800">© 2023 ComFort</p>
        </div>
      </footer>
    </div>
  );
